    ...
    <div className="min-h-screen flex items-center justify-center bg-muted/30 p-4 sm:p-6">
      <div className="w-full max-w-sm mx-auto">
        ...
        <div className="text-center mb-8 sm:mb-10">
          <h1 className="text-4xl sm:text-3xl font-bold tracking-tight">ContaFácil</h1>
          <p className="text-muted-foreground mt-3 sm:mt-2 text-lg sm:text-base">Sistema de gestão contábil</p>
        </div>
        
        <Card className="border shadow-lg">
          <CardHeader className="px-6 py-8 sm:px-6 sm:py-6">
            <CardTitle className="text-2xl sm:text-xl">Acesso ao Sistema</CardTitle>
            <CardDescription className="text-lg sm:text-sm mt-2">
              Faça login ou cadastre-se para acessar o sistema
            </CardDescription>
          </CardHeader>
          
          <CardContent className="px-6 pb-6 sm:px-6">
            <Tabs value={activeTab} onValueChange={setActiveTab}>
              <TabsList className="grid w-full grid-cols-2 h-14 sm:h-10 mb-8 sm:mb-6">
                <TabsTrigger value="login" className="text-lg sm:text-sm font-medium">Login</TabsTrigger>
                <TabsTrigger value="signup" className="text-lg sm:text-sm font-medium">Cadastro</TabsTrigger>
              </TabsList>
          ...
          <CardFooter className="px-6 py-8 sm:px-6 sm:py-6">
            <AuthFooter />
          </CardFooter>
        </Card>
      </div>
