  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
        <h3 className="text-lg font-medium mb-4">Integração com Receita Federal (e-CAC)</h3>
        ...
        <h3 className="text-lg font-medium pt-4 mb-4">Integração com Secretaria da Fazenda Estadual</h3>
        ...
        <h3 className="text-lg font-medium pt-4 mb-4">Integração com Prefeitura</h3>
