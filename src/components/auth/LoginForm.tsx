    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 sm:space-y-4">
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className="text-sm sm:text-sm font-medium">Email</FormLabel>
              <FormControl>
                <Input
                  ...
                  autoComplete="email"
                  disabled={loading}
                  className="h-12 sm:h-10 text-base sm:text-sm px-3 py-3 sm:px-3 sm:py-2"
                />
              </FormControl>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className="text-sm sm:text-sm font-medium">Senha</FormLabel>
              <FormControl>
                <Input
                  placeholder="******"
                  type="password"
        ...
        />
        <Button type="submit" className="w-full h-12 sm:h-10 text-base sm:text-base font-medium mt-6 sm:mt-4" disabled={loading}>
          {loading ? (
            <>
