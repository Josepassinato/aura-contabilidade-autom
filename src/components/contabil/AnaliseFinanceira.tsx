...
export function AnaliseFinanceira() {
  ...
  const loadDadosFinanceiros = async () => {
    try {
      // Simulação de dados financeiros (em produção viria de cálculos baseados nos dados contábeis)
      const mockIndicadores: IndicadorFinanceiro[] = [
        {
          nome: 'Liquidez Corrente',
          valor: 1.85,
          periodo_anterior: 1.72,
          meta: 2.0,
          unidade: 'indice',
          categoria: 'liquidez',
        ...
        },
        {
          nome: 'Liquidez Seca',
          valor: 1.45,
          periodo_anterior: 1.38,
          meta: 1.5,
          unidade: 'indice',
          categoria: 'liquidez',
          descricao: 'Liquidez desconsiderando estoques'
        },
        {
          nome: 'Margem Líquida',
          valor: 12.5,
          periodo_anterior: 10.8,
          meta: 15.0,
          unidade: 'percentual',
          categoria: 'rentabilidade',
          descricao: 'Percentual de lucro sobre receitas'
        },
        {
          nome: 'ROE',
          valor: 18.2,
          periodo_anterior: 15.6,
          meta: 20.0,
          unidade: 'percentual',
          categoria: 'rentabilidade',
          descricao: 'Retorno sobre Patrimônio Líquido'
        },
        {
          nome: 'ROA',
          valor: 8.7,
          periodo_anterior: 7.9,
          meta: 10.0,
          unidade: 'percentual',
          categoria: 'rentabilidade',
          descricao: 'Retorno sobre Ativos'
        },
        {
          nome: 'Endividamento Geral',
          valor: 35.5,
          periodo_anterior: 38.2,
          meta: 30.0,
          unidade: 'percentual',
          categoria: 'endividamento',
          descricao: 'Participação de terceiros no financiamento'
        },
        {
          nome: 'Giro do Ativo',
          valor: 0.92,
          periodo_anterior: 0.88,
          meta: 1.0,
          unidade: 'indice',
          categoria: 'atividade',
          descricao: 'Eficiência na utilização dos ativos'
        },
        {
          ...
          unidade: 'indice',
          categoria: 'atividade',
          descricao: 'Dias médios para recebimento de vendas'
        }
      ];

      const mockAnaliseComparativa: AnaliseComparativa[] = [
        {
          periodo: '2024-01',
          receitas: 2500000,
          despesas: 2187500,
          lucro_liquido: 312500,
          margem_liquida: 12.5
        },
        {
          periodo: '2023-12',
