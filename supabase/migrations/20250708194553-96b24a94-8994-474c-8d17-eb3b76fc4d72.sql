-- Inserir dados de teste para demonstração (corrigido)
-- Cliente de exemplo
...
-- Obrigações fiscais de exemplo (com status corretos)
...
('55555555-5555-5555-5555-555555555555', '11111111-1111-1111-1111-111111111111', 'GFIP Janeiro 2024', 'GFIP', '2024-02-07', 'Empresa Teste LTDA', 'entregue', 'media')
ON CONFLICT (id) DO NOTHING;
...
('66666666-6666-6666-6666-666666666666', '11111111-1111-1111-1111-111111111111', '2024-01', 45231.89, 12234.12, 32997.77, 32997.77, '{"das": 1500.00, "inss": 800.00, "irpj": 600.00}')
ON CONFLICT (id) DO NOTHING;

-- Documentos de exemplo
INSERT INTO client_documents (id, client_id, name, title, type, status, size) VALUES 
('77777777-7777-7777-7777-777777777777', '11111111-1111-1111-1111-111111111111', 'nfe_janeiro_2024.xml', 'Notas Fiscais Janeiro 2024', 'NFE', 'processado', 15432),
('88888888-8888-8888-8888-888888888888', '11111111-1111-1111-1111-111111111111', 'balancete_jan24.pdf', 'Balancete Janeiro 2024', 'BALANCETE', 'pendente', 8921)
ON CONFLICT (id) DO NOTHING;
